...
SELECT name FROM people WHERE name = 'Shannon Holmes';
...
INSERT INTO movies (title, show_time) VALUES ('Captain Marvel', '00:00');
UPDATE movies SET year = 2019 WHERE title = 'Captain Marvel';
